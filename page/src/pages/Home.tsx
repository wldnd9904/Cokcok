  ...
  return (
    <Container>
      ...
      <Card>
        ...
        <Card.Body>
          <ImageContainer>
            <img width="200px" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/logo_large.png?raw=true"/>
          </ImageContainer>
          ...
          <ImageContainer>
          <img width="30%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/iOS.png?raw=true"/>
          <img width="30%" height="30%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/watchOS.png?raw=true"/>  
          </ImageContainer>
        </Card.Body>
      </Card>
      <Card>
        ...
        <Card.Body>
          ...
          <ImageContainer>
            <img width="30%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/스윙기록_3.png?raw=true"/>
            <img width="30%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/스윙분석_2.png?raw=true"/>
          </ImageContainer>

          <h5>경기 기록</h5>
          <p>IMU센서를 이용해 경기를 기록하고, 운동 정보와 경기 중의 스윙들을 분석합니다.</p>
          <ImageContainer>
            <img width="30%" height="30%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/경기기록_워치_결과_요약_.png?raw=true"/>  
            <img width="30%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/경기기록_1_운동세부사항.png?raw=true"/>
            <img width="30%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/경기기록_3_스트로크_선택.png?raw=true"/>
          </ImageContainer>
          
          <h5>요약</h5>
          <p>이번 달의 배드민턴 통계를 확인하고, 업적을 확인할 수 있습니다.</p>
          <ImageContainer>
            <img width="30%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/요약_페이지.png?raw=true"/>
            <img width="30%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/요약_전체_업적.png?raw=true"/>
          </ImageContainer>
      ...
      <Card>
        ...
        <Card.Body>
          <ImageContainer>
            <img width="100%" src="https://github.com/wldnd9904/Cokcok/blob/main/page/images/architecture.png?raw=true"/>
          </ImageContainer>
        </Card.Body>
      </Card>
      <Card>
